...
/**
 * \brief process the query and give the answer.
 * 
 * \param *ptr_q			pointer to the query.
 * \param *send_buf			pointer to the buf to store the anser. 
 * \param *pattern_file		The file that used to do the pattern match.
 * 
 * \return length			The length of send_buf used.
*/
